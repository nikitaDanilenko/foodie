...
fetchMeals flags =
    HttpUtil.getJsonWithJWT flags.jwt
        { url = Links.backendPage flags.configuration [ "meal", "all" ] []
...
createMeal flags mealCreation =
    HttpUtil.postJsonWithJWT flags.jwt
        { url = Links.backendPage flags.configuration [ "meal", "create" ] []
...
saveMeal flags mealUpdate =
    HttpUtil.patchJsonWithJWT flags.jwt
        { url = Links.backendPage flags.configuration [ "meal", "update" ] []
...
deleteMeal flags mealId =
    HttpUtil.deleteWithJWT flags.jwt
        { url = Links.backendPage flags.configuration [ "meal", "delete", mealId ] []
